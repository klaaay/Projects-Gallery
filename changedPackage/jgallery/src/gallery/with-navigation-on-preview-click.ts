    ...
    class extends constructor {
        constructor(albums: AlbumItem[], params: Params) {
            ...
            this.left = createElement(`
                <div class="j-gallery-left" style="left: 0; width: 50%; top: 0; bottom: 0; position: absolute; cursor: pointer; display: none"></div>
            `);
            this.left.addEventListener('click', () => {
                this.prev();
            });
            this.right = createElement(`
                <div class="j-gallery-right" style="right: 0; width: 50%; top: 0; bottom: 0; position: absolute; cursor: pointer; display: none"></div>
            `);
